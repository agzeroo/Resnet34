...
dataset_paths = [
    'C:/Users/master15/Desktop/0819_test/']
output_paths = [
    'C:/Users/master15/Desktop/0819_test/aligement/']
...
for (i, dataset_path) in enumerate(dataset_paths):
    ...
    for idx in range(number_images):
        input_file = dataset_path + str("img_") + str(idx) + image_type
        ...
        for (i, rect) in enumerate(rects):
            ...
            output_file = output_path + str(idx+1) + image_type_2
